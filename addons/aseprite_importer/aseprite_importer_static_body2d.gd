...
func _get_importer_name() -> String: return "aseprite.importer.staticbody2d"
func _get_visible_name() -> String: return "StaticBody2D (Aseprite)"
func _get_recognized_extensions() -> PackedStringArray: return ["aseprite", "ase"]
func _get_resource_type() -> String: return "PackedScene"
func _get_save_extension() -> String: return "tscn"
